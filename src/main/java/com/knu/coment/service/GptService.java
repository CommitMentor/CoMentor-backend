...
public class GptService {
    ...
    public String createPromptForAnswerProject2(String userCode, String csQuestion) {
        ...
        prompt.append("당신은 10년 경력의 시니어 소프트웨어 엔지니어이자 면접관입니다.\n")
                .append("아래 제공된 코드, 질문을 참고하여 정확한 해설을 제시하세요.\n\n");
        ...
        prompt.append("#### 지침\n")
                ...
                .append("   - 면접 시 답변하듯 **상세하게**, 고려한 과정과 근거를 포함하여 설명하세요.\n\n")
                .append("   ## 📝 추가 정보\n")
                .append("   -  정확한 답변의 지식에서 관련해서 알아야할 지식이 있다면 상세히 작성하세요\n")
                .append("   ```\n\n");
        ...
        prompt.append("#### 예시 출력\n")
                ...
                .append("- 힙 정렬은 힙 자료구조를 활용해 배열을 최대 힙으로 만든 뒤, 루트 값을 교환하고 힙을 재구성하는 과정을 반복합니다. 이로써 전체 정렬이 O(n log n)에 수행됩니다.\\n\\n")
                .append("## 📝 추가 정보\\n")
                .append("- 힙 정렬은 완전 이진 트리의 일종으로 우선순위 큐를 위하여 만들어진 자료구조 입니다.\"\n")
                .append("  }\n")
                .append("]\n")
                .append("```");

        prompt.append("위 예시처럼 'feedback' 키 아래에 상세한 해설을 작성하세요");
    ...
    public String createPromptForAnswerCS2(
        ...
        prompt.append("당신은 10년 경력의 시니어 소프트웨어 엔지니어이자 면접관입니다.\n")
                .append("아래 제공된 사용자 스택, 질문 카테고리, 질문(및 포함된 코드 예시)를 참고하여, 정확한 해설을 제시하세요.\n\n");
